...
#   pass
# """
# from tensorflow import keras, concat, expand_dims, reshape, nn, reduce_sum, zeros, concat, data, random
# from tensorflow import argmax, convert_to_tensor, GradientTape, reduce_mean, math
# from tensorflow import train as train_tf
# from tensorflow import function as function_tf
...
#     )
#     """
#     if len(self.input_tensor) > 50000 :
#       self.input_tensor = self.input_tensor[:50000]
#     if len(self.target_tensor) > 50000 :
#       self.target_tensor = self.target_tensor[:50000]
...
#     self.dataset = data.Dataset.from_tensor_slices((self.input_tensor_train, self.target_tensor_train)).shuffle(self.BUFFER_SIZE)
...
#     self.sample_decoder_output, _, _ = self.decoder(random.uniform((self.BATCH_SIZE, 1)), self.sample_hidden, self.sample_output)
...
#     self.checkpoint = train_tf.Checkpoint(optimizer=self.optimizer, encoder=self.encoder, decoder=self.decoder)
...
#         dec_input = expand_dims(targ[:, t], 1)
...
#       hidden = [zeros((1, self.units))]
#       enc_out, enc_hidden = self.encoder(inputs, hidden)

#       dec_hidden = enc_hidden
#       dec_input = expand_dims([self.targ_lang.word_index['<start>']], 0)
...
#         predicted_id = argmax(predictions[0]).numpy()
...
#   def afterTranslate(sentence): 
#     s =  word_tokenize(sentence.strip()) #.split(' ') 
#     print(s)
#     l = len(s)
#     if l > 1 :
#       sc = s.copy()
...
#     self.checkpoint.restore(train_tf.latest_checkpoint(self.checkpoint_dir+'/'+self.input_language+'_'+self.target_language))
...
# main_list = [
# {"langue":"Francais", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20},
# #{"langue":"Anglais", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Fulfulde", "concatenation":["Fulfulde_Adamaoua", "Fulfulde_DC"], "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Bulu", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# {"langue":"Gbaya", "concatenation":["KALATA_KO_SC_Gbaya", "KALATA_KO_DC_Gbaya"], "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"MASSANA", "concatenation":["BIBALDA_TA_PELDETTA"], "num_examples":None, "test_size":0.2, "EPOCHS":20},
# # {"langue":"Guiziga", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Kapsiki", "concatenation":["Kapsiki_DC"], "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Tupurri", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Bafia", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Ejagham", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Ghomala", "concatenation":None},
# # {"langue":"Ewondo", "concatenation":["MKPAMAN_AMVOE_Ewondo"], "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Ngiemboon", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20},
# # {"langue":"Dii", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Vute", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Limbum", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Mofa", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Mofu_Gudur", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Doyayo", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":10}, 
# # {"langue":"Guidar", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":10}, 
# # {"langue":"Peere_Nt&Psalms", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Samba_Leko", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}, 
# # {"langue":"Du_na_sdik_na_wiini_Alaw", "concatenation":None, "num_examples":None, "test_size":0.2, "EPOCHS":20}
# ]
